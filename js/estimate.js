...
document.getElementById('save').addEventListener('click', function(){
  ...
  .then(function(){
    ...
    var wsjfval = ((Number(ubvSelector.value)+Number(tcSelector.value)+Number(rroeSelector.value))/Number(jsSelector.value))
    return t.set('card', 'shared',  'wsjf', (wsjfval).toFixed(2));
  })
  .then(function(){
